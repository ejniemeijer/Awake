...
- **Move cursor 1px when idle** (menu toggle, on by default): after a minute without input, the cursor moves 1px and straight back, so apps like Teams and Slack keep showing you as active. This needs Accessibility permission; the menu offers a shortcut to grant it.
