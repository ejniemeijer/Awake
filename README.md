...
- **Move cursor 1px when idle** (menu toggle, on by default): after you've been idle for the chosen time (30 s, 1, 2 or 4 min; default 1 min), the cursor moves 1px and straight back, so apps like Teams and Slack keep showing you as active. This needs Accessibility permission; the menu offers a shortcut to grant it.
